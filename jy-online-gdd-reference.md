...
### 📊 ระบบสเตตัสตัวละคร (角色屬性系統) `[ยืนยันได้]`
> [!info] โครงสร้างสเตตัสแบ่งได้ 4 กลุ่ม — ผสม "ค่าต่อสู้" + "ค่าคุณสมบัติกำเนิด" + "ค่าสภาพ" + "ค่าซ่อน"

**A) ค่าพื้นฐาน (基本屬性):** 精 (จิต) · 氣 (ปราณ) · 神 (วิญญาณ) · 內力 (ลมปราณ)

**B) ค่าต่อสู้ (戰鬥屬性):**
- **氣血 (HP)** สูง = อึด · **防禦** สูง = เสียเลือดน้อยลง (HP+防禦 = EHP)
- **武力 (外功)** = ฐานดาเมจกายภาพ · **內力** = ดาเมจสายใน → ดาเมจรวม = **%武力 + %內力 ตามสัดส่วนของแต่ละวิชา**
- **身法** = **ลำดับออกท่าในเทิร์น** (สูง=ออกก่อน) ต่างกันตามอาชีพ — ค่าที่ "มีดีไซน์ที่สุด"
- ค่าพิเศษเพดาน 100: **攻擊力 / 防禦力 / 輕功** (輕功 = จำนวนก้าวเดินในต่อสู้ + turn priority) · **醫療能力** (รักษาคนอื่น) · **用毒能力** (โอกาสลงพิษ)

**C) ค่าคุณสมบัติกำเนิด 7 ค่า (資質屬性) — กำหนดตอนสร้างตัว + พัฒนาผ่านการเล่น:**

| ไทย | จีน | ผล | เพิ่มจาก (ทุก 10 lv. +1) |
|-----|-----|-----|------|
| พลังแขน | 臂力/膂力 | น้ำหนักแบก + ผลโจมตีกายภาพ | ต่อสู้มือเปล่า (搏擊格鬥) |
| ความกล้า | 膽識 | ออกท่าเร็ว/ความกล้า — ฝึก 葵花寶典 ต้อง ≥25 | — |
| รู้แจ้ง | 悟性 | **ฝึกวิชาเร็ว + ได้แต้มบำเพ็ญ (修為) มาก** | เรียนหนังสือ (讀書識字) |
| วาสนา | 福緣 | โชค/โอกาส (drop/เหตุการณ์) — เควสต์วิชาพิเศษ ≥19 | — |
| ฟื้นฟู/สมาธิ | 定力 | ต้านทานจิต + สะสมพลัง — เควสต์วิชาพิเศษ ≥20 | — |
| ปฏิภาณ | 機敏 | ส่งผลต่อ 身法/หลบหลีก — ≥21 | ทะยานหลบหลีก (閃躲蹤躍) |
| กระดูก | 根骨 | ความแกร่ง/เลือด — **1 根骨 = 70 HP** | พลังภายในพื้นฐาน (基本內功) |

> ค่ากำเนิดเหล่านี้ **gate การเรียนวิชาชั้นสูง** · ตัวอย่างบิลด์สาย 獨孤九劍+幻陰指: รู้แจ้ง30/กระดูก30/ปฏิภาณ22/ความกล้า23/พลังแขน15/วาสนา15/ฟื้นฟู15

**D) ค่าสภาพ + ค่าซ่อน:**
- **狀態屬性 (survival):** 飽食度 (อิ่ม) · 飲水度 (น้ำ) · 負重 (น้ำหนักแบก)
- **隱藏屬性:** 道德 (คุณธรรม — 清心/斷惡/慈悲 ตามสำนัก) · 聲望 (ชื่อเสียง) · 體質 (อัตราโตเมื่อเลเวลอัป) · 資質 (ความเร็วฝึกวิชา)

**E) การจัดแต้ม & เสริมสเตตัส:** 至尊版 แจกฟรี 5 แต้มใส่ได้เลย (เลิกทอยลูกเต๋า) + 完美屬性丹 รีเซ็ต · 內功เสริมทั้งโจมตี/ป้องกันแบบสุ่ม · ระบบ 武林英雄帖/侠客系統 เพิ่ม atk/def/暴擊(crit)/閃避(dodge)

### 🎂 ระบบวันเกิด (生日系統) `[ยืนยันได้]`
> [!info] ฟีเจอร์ล้ำยุค (มาพร้อม auction house ตั้งแต่ปี 2001)
- กำหนด **วันเกิด** ตอนสร้างตัวละคร · ปฏิทินในเกม **1 ปีในเกม (游庸年) = 1 เดือนจริง** → วันเกิดเวียนมาทุก ~1 เดือนจริง
- ถึงวันเกิด → **สเตตัสเพิ่มสุ่ม 0–2 แต้ม** (โอกาสสูงสุดคือ +1) = ช่องทางเพิ่มสเตตัสฟรีระยะยาว
- **เทคนิค:** ตั้งวันเกิดให้ถัดจากเวลาในเกมตอนสร้างตัว 1 วัน (เช่นในเกมเป็น 1 พ.ค. → ตั้ง 2 พ.ค.) เพื่อรับโบนัสเกือบทันที
- มุมดีไซน์: retention loop เล็ก ๆ ผูกกับปฏิทินในเกม + สร้างความผูกพันกับตัวละคร

### 🌀 ระบบกำลังภายใน (內力系統) `[ยืนยันได้]`
- **內力 = MP** กำหนดจำนวนครั้งที่ออกท่า/สกิลได้
- **"สำแดง" ด้วยสีตามสาย:** วิชาอิน/อ่อน (陰柔) = ตัวเลข**สีม่วง** · หยาง/แข็ง (陽剛) = **สีเหลือง** · สมดุล (陰陽調和) = **สีขาว**
- **基本內功 (วิชาภายในพื้นฐาน):** กำหนด**เพดานพลังภายใน** · ทุก 10 เลเวล → +1 กระดูก (根骨) · ~140 เลเวล ≈ 700 พลังภายใน
- **修煉內力 (เดินลมปราณ):** เปิด **指令→武學→修煉內力** (ต้องติ๊ก 心法 ก่อน) — ทุก 1 เลเวล基本內功 บำเพ็ญได้ 5 ครั้ง (+氣/+內 ต่อครั้ง) `[ตัวเลขต้องยืนยันเพิ่ม]`
- **ฟื้นฟู:** สกิล **凝神調息** ฟื้น 氣血 · **氣匯百川** แปลง 體力→內力 · 體力 (stamina เพดาน 5) ฟื้นจากอาหาร/ดื่มชาในเมือง/รอเวลา
- **ฝึกอัตโนมัติ (自修/自動戰鬥):** เข้าถ้ำฝึก → 指令→武學→自動戰鬥 → ติ๊ก "จ่ายเงินเติม內力อัตโนมัติ" → ฝึกเองได้ทั้งแต้มเรียน + ประสบการณ์รบ

### 🦅 ระบบวิชาตัวเบา (輕功系統) `[ยืนยันได้]`
- **ผล 4 มิติ:** (1) ความเร็วเดินทางนอกสนาม · (2) **จำนวนก้าวเดินในต่อสู้ (move range)** · (3) **ลำดับออกท่า** (สูง=ก่อน, เพดาน 100) · (4) **อัตราหลบ (閃躲縱躍 — auto)**
- **ฟังก์ชันพิเศษในสนาม:** กระโดดข้ามศัตรู (跳過敵人) + หนีออกจากที่ (原地逃離) — **เปลือง內力**

| วิชาตัวเบา | เงื่อนไข | โบนัส 輕功 | ที่มา |
|-----------|----------|-----------|-------|
| 梯雲縱心法 | ใครก็ฝึกได้ | +3 | สำนักบู๊ตึ๊ง (武當) |
| 神行百變 | 資質 ≥30 | +4 | เกาะ 浡泥島 (หลังเข้าร่วม 袁承志) |
| 凌波微步 | 資質 ≥60 | +5 | 無量山 — วิชาเด่นสำนักเซียวเอี้ยว (逍遙派) |

> 💡 輕功 = สเตตัสเชิงยุทธวิธี (ระยะเดิน + initiative + หลบ) สำคัญพอ ๆ กับพลังโจมตี ไม่ใช่แค่ "วิ่งเร็ว"

### ⚔️ ระบบการสวมใส่อุปกรณ์ (裝備系統) `[ยืนยันได้]`
**ช่องสวมใส่ ~8 ช่อง:** 武器 (อาวุธ) · 衣服 (เสื้อ/เกราะ) · 帽子/頭盔 (หมวก) · 護手/護腕 (สนับมือ) · 鞋子 (รองเท้า) · 戒指 (แหวน) · 項鍊 (สร้อยคอ) · 披風 (ผ้าคลุม)

- **ประเภทอาวุธ 5 ชนิด (ผูกกับวิชา):** 刀 (ดาบ) · 劍 (กระบี่) · 拳套 (สนับมือ) · 棍 (พลอง) · 杖 (ไม้เท้า) → ต้องเข้าคู่กับวิชาที่ฝึก
- **คุณสมบัติ:** โจมตี/ป้องกัน · เลเวลที่ใช้ได้ · **ความทนทาน (耐久)** · น้ำหนัก (負重) · โบนัส (HP/MP, ความเร็วรักษา, 命中/閃避) · **ต้านทาน 4 ธาตุ (四種抗性)** · เพิ่มค่ากำเนิด (臂力/悟性/福緣/定力/機敏)
- **專屬 (เฉพาะสำนัก)** ค่าดีกว่าแต่จำกัดสำนัก · **通用 (ทั่วไป)** ใส่ได้ทุกคน
- **ตีบวก/強化:** กลไก **สำเร็จ +1 / ล้มเหลว −1** (เช่น สร้อย 朱雀/麒麟/青龍) · 3 ระดับแรกโอกาสสูง → ควร save ก่อนตี + หลังสำเร็จ · **鑲嵌** ฝัง 天地人寶石 (0–3 ช่อง)
- **ซ่อม:** ความทนทานลด → ซ่อมที่ 錢莊 = gold sink
- **เซ็ตอุปกรณ์:** เช่น 真朱雀裝備 (ครบชุด), **至尊天悟裝** (4 ชิ้น: เสื้อ/หมวก/รองเท้า/สนับมือ → ดันความชำนาญวิชา)
- **UI:** ปุ่ม 「装备」 มุมขวาบน · hover ดู tooltip · ได้จาก เควสต์/คราฟต์/พ่อค้า NPC/拍賣行 (ดูหัวข้อ 5)
...
### 🏙️ ระบบในเมือง (城鎮設施 & NPC) `[ยืนยันได้]`
> [!info] เมือง = hub บริการครบวงจรก่อนออกยุทธภพ — ผู้เล่นใหม่มี "เส้นทางในเมือง" ชัดเจน
> เมืองหลักที่อ้างถึง: 大理城 · 西夏城 · 京城/上京 · 揚州 · 無錫鎮 · 靈州城 ฯลฯ

| สถานที่ | หน้าที่ |
|---------|---------|
| 🥋 สำนักดาบ (武館) | เรียนวิชาพื้นฐานก่อนเข้าสำนัก + **รักษาบาดเจ็บภายใน/ภายนอก** |
| 🏦 ธนาคาร (錢莊 / 銀號) | ฝาก-ถอนเงิน · ฝากของ · **ซ่อมอุปกรณ์ชำรุด** |
| 🛡️ สำนักคุ้มกัน (鏢局) | งาน **托鏢 (ขนส่งสินค้า)** + รับของที่ฝากขนส่ง |
| 🏮 โรงเตี๊ยม (客棧) | ซื้ออาหาร · พักฟื้น · **ฟังข่าวสาร/ข่าวลือ** |
| 📜 กระดานข่าว (布告欄) | รับเควสต์เมือง + NPC บริการ (เช่น 門派傳送員) |
| 📖 บัณฑิตตกอับ (落第秀才) | เรียน **讀書識字 (อ่านออกเขียนได้)** ด้วยเงินเล็กน้อย — มีทุกเมือง |
| ⚒️ ช่างฝีมือ (工匠 / 打鐵鋪) | ตี/คราฟต์อาวุธ-ของ (อยู่ใกล้ทหารยามประตูเมือง) |
| 💊 ร้านยา · 🎲 บ่อน (賭場) · 🍜 แผงอาหาร (面摊/肉摊) | บริการชีวิต/เศรษฐกิจย่อย |

- **เควสต์เมือง (城市任務) + ทำงานหาเงิน (做工):** เริ่มเกมมีเงิน 0 → ต้องหา **~300 ตำลึง** เพื่อเข้าสำนัก
  - งานกุลี (苦力男): วน 捆貨工(錢莊)→苦力男(客棧)→陳鏢師(鏢局)→藥商(ร้านยา) → ได้ ~**1,000 ตำลึง**
  - ช่วย 司馬豪雲 ทำนาที่ประตูเมือง → ได้ ~**300 ตำลึง**

### ⏳ ระบบเวลา (時間系統) `[ยืนยันได้]`
- **เวลาออนไลน์สะสม (在線時間累計) — แกนสำคัญสุด:** เป็น **time-gate ปลายเกม** สำหรับเรียนวิชาชั้นสูง (絕學)
  - หลายวิชาต้อง **ออนไลน์ครบ 3,000 ชม.** เช่น 降龍十八掌 · 獨孤九劍奧義 · 六脈神劍 · 野球拳 (ผูกเงื่อนไขระดับวิชาอื่นด้วย เช่น 太玄經 = 3,000 ชม. + 乾坤大挪移 lv.90)
  - **เงื่อนไขเวลา/สเตตัสตอนเรียน → กำหนดเลเวลเริ่มต้นของวิชา** (เงื่อนไขต่ำ = เริ่ม lv.150 · สายสเตตัสล้วน = lv.180 · เงื่อนไขสูง = lv.200)
- **ตารางกิจกรรม (活動時刻表):** เปิดจาก **指令→雜項→活動時刻表** → แสดงกิจกรรมทั้งสัปดาห์, วันนี้ขึ้น**กรอบแดง**, กดเทเลพอร์ตไปจุดกิจกรรมได้ (ฟีเจอร์ 至尊版); กิจกรรมประจำมีช่วงเวลาตายตัว (เช่น 12:35–12:55, 22:35–22:55)
- **บำรุงรักษา (維護):** จ–ศ 07:00–07:30 · ส–อา 09:30–10:00 · วันที่ 1 ของเดือน ระบบกู้คืนไอเทมอัตโนมัติ
- **ฝึกวิชาตามเวลา (修煉/自動練功):** เวอร์ชันเก่าต้องเปิดฝึกค้างนาน (เคยถึง 24 ชม.); **至尊版 ลดเวลา + เพิ่ม automation** (QoL)
- **防沉迷 (anti-addiction):** เซิร์ฟจีนมีหน้า verification/จำกัดเวลาเล่นตามกฎจีน `[ยืนยันได้ — รายละเอียดจำกัด]`
- **แถบเวลาต่อสู้ (時間條/绿棒):** จังหวะเทิร์น — รอแถบเต็มก่อนสั่งการ, สกิล 聚气 เร่งเต็มไว (ดูหัวข้อ 5)
- **วัฏจักรกลางวัน-กลางคืน (晝夜系統):** **มีจริง** แต่ผู้เล่นมองว่า **ทำได้ไม่ดี (เป็นหนึ่งในข้อตำหนิที่ทำให้เกมเสื่อม)** `[ยืนยันได้ — จากรีวิว 知乎]`
  - ผลกระทบ: **กลางคืน NPC บางตัวไม่ปรากฏ** (เช่น 察小庸 ที่ทางเข้าสำนัก/客棧 → หาไม่เจอตอนกลางคืน) และ **ส่งผลต่อภารกิจขนส่ง (運鏢/托鏢)** (รายละเอียดไม่ชัด + มีบั๊กขบวนหาย)
- **ระบบสภาพอากาศ (天氣系統):** มี เช่น ฝน (เส้นฝนทับฉาก); เวอร์ชันใหม่มี "天氣優化" ปรับปรุง `[ยืนยันได้]`

> [!note] ⚠️ ยังไม่พบยืนยัน: ระบบ **ฤดูกาล (季節) / หิมะ (雪)**
> แหล่งจีน/ไต้หวันยังไม่ระบุชัด — ต้องดูคลิป gameplay เพิ่มถ้าจะยืนยัน
>
> 💡 หมายเหตุดีไซน์: รีวิวชี้ว่า JY Online **ล้ำยุค** — ริเริ่ม split-scene dialogue, auction house, support class, ranking, daily quest (運鏢), พาหนะสาธารณะ (เกวียน) ก่อน WoW ~4 ปี — แต่ระบบ 晝夜/運鏢ที่ทำไม่เนียน + บั๊ก + ปล่อยโปรแกรมโกง คือส่วนหนึ่งของการเสื่อม
...
### 🏯 ระบบพรรค/กิลด์ (帮派 / Faction) `[ยืนยันได้]`
- **โครงสร้าง 5 ชั้น:** 帮主 (หัวหน้าพรรค ×1) → 副帮主 (รอง ×2) → 执行头目 (หัวหน้าสาย ×4) → 执行干事 (เจ้าหน้าที่ ×8) → 一般帮众 (สมาชิกทั่วไป ไม่จำกัด)
- **เงื่อนไขตั้งพรรค:** ต้องได้ **拥护权 (เสียงสนับสนุน) จากผู้เล่น 30 คน** + บรรลุระดับชื่อเสียง **赫赫有名**
- ใช้คำสั่ง **「สร้างองค์กร (创建帮派)」** → เปิดหน้าต่างระบบให้ยืนยันชื่อพรรค, ตั้งชื่อตำแหน่งแต่ละชั้น และค่าตั้งอื่น ๆ

### 🛒 ค้าขาย / ตลาด / ร้านค้า `[ยืนยันได้]`
- **擺攤系統 (ตั้งแผง):** วิธีซื้อขายระหว่างผู้เล่นที่ใช้บ่อยสุด — เปิดแผงขายของได้เอง
- **區域攤位查詢 (ค้นแผงทั้งโซน — ฟีเจอร์ 至尊版):** เปิดจาก **指令→雜項→區域攤位資訊** → หน้าต่างแสดงจำนวนคงเหลือ + ราคาของแต่ละแผง (ต้องเป็น VIP ระดับ 白金 ขึ้นไป)
- **店鋪 (ร้าน NPC):** ออกแบบ**หน้าตาร้านให้ดูออกว่าขายอะไร** — คลิกคุยกับ NPC เพื่อซื้อขาย
- **商城 (Cash Shop):** กดปุ่ม **「商」 มุมขวาบน** → เลือกของตาม **「類別 (หมวด)」** แบ่งเป็นหมวดใหญ่/หมวดย่อย, ราคาคิดเป็น **點數 (game points)**

### 🗺️ แผนที่ / เดินทาง / เควสต์ `[ยืนยันได้]`
- **ระบบพิกัด (座標):** ทุกโลเคชัน/NPC มีพิกัดชัดเจน → ใช้นำทางได้ (เมืองหลัก เช่น 無錫鎮/大里城/上京城/燕京城/靈州城 มีแผนที่ NPC แยกราย)
- **驛站 (สถานีม้าเร็ว/Post station):** จุดเดินทางข้ามแผนที่
- มี **小地圖 (minimap)** ในหน้าจอ + แผนที่โลกเต็มแยกราย `[อิงรีวิว — แหล่งเน้นพิกัดมากกว่าภาพ UI]`

### 🏠 ระบบชีวิต / บ้าน (生活 / 家園) `[ยืนยันได้]`
- **แต่งงาน (結婚) + มีบุตร (生子)**
- **อสังหาฯ:** 買地置業 (ซื้อที่) → เลือกทำเล (地段) → 購地建房 (สร้างบ้าน) → 布置房屋 (ตกแต่ง) → 家具授權 (ให้สิทธิ์ใช้เฟอร์นิเจอร์)

### ⚒️ คราฟต์ / หล่อหลอม (打造 / 養成) `[ยืนยันได้]`
- **內丹進化 (วิวัฒนาการแกนใน):** คุยกับ NPC 孫先生 ที่เมืองหลวง → แกนใน 5 ธาตุแปลงเป็นรูปที่เสริมได้ **หน้าต่าง UI เปลี่ยนทั้งชุด** เริ่มที่ระดับ 0 ดาว
- **เสริมแกนใน:** ใช้ **定性珠** (ล้มเหลว → ระดับลดลง) หรือ **菩提珠** (ล้มเหลว → ระดับไม่ลด) — สื่อความเสี่ยงผ่านชนิดไอเทมชัดเจน
- **鑲嵌 (ฝังอัญมณี):** อาวุธ/เกราะขั้นสูงฝัง **天地人寶石** ได้ตามจำนวนช่อง **0/1/2/3 ช่อง**
- **至尊天命武器:** อาวุธพิเศษที่ดันค่าความชำนาญ (自修/天悟熟練度) ได้พร้อมกัน
...
> - ✅ **ตั้งพรรคผ่านหน้าต่างเดียวจบ** (ตั้งชื่อ/ตำแหน่ง/ลำดับชั้น) + gate ด้วย "เสียงสนับสนุน 30 คน" = สร้าง social commitment ก่อนได้ระบบ
> - ✅ ตลาดผู้เล่นใช้ **ตั้งแผง (擺攤) + ค้นหาข้ามโซน** ลดเวลาเดินหา; ร้าน NPC ใช้ **หน้าตาอาคารสื่อประเภทสินค้า** (อ่านโลกได้โดยไม่ต้องคลิก)
> - ✅ ระบบเสริมของ(內丹/鑲嵌) สื่อความเสี่ยงผ่าน **ชนิดไอเทม (ล้มแล้วลด vs ไม่ลด)** แทนตัวเลขเปอร์เซ็นต์ล้วน
> - ✅ นำทางด้วย **ระบบพิกัด + minimap + 驛站 (fast-travel hub)** ; ระบบบ้าน/แต่งงานเป็น sink และ social anchor ปลายเกม
...
> - [x] **UX/UI ระบบอื่น ๆ** — พรรค/帮派 (โครงสร้าง 5 ชั้น + หน้าต่างตั้งพรรค), ตลาด/擺攤/區域攤位查詢, 店鋪/商城, แผนที่+พิกัด+驛站, ระบบบ้าน/แต่งงาน, คราฟต์ 內丹進化/鑲嵌 (หัวข้อ 5)
> - [x] **ระบบในเมือง (城鎮設施)** — 武館/錢莊/鏢局/客棧/布告欄/落第秀才/工匠/賭場, เควสต์เมือง + 做工 หาเงินมือใหม่ (หัวข้อ 1)
> - [x] **ระบบสเตตัสตัวละคร (角色屬性)** — ค่าพื้นฐาน/ค่าต่อสู้ (氣血/武力/內力/身法), ค่าคุณสมบัติกำเนิด 7 ค่า (臂力/膽識/悟性/福緣/定力/機敏/根骨 = พลังแขน/ความกล้า/รู้แจ้ง/วาสนา/ฟื้นฟู/ปฏิภาณ/กระดูก), ค่าสภาพ/ค่าซ่อน (หัวข้อ 1)
> - [x] **ระบบวันเกิด (生日系統)** — ตั้งวันเกิดตอนสร้างตัว, 1 ปีในเกม=1 เดือนจริง, ถึงวันเกิด +0–2 สเตตัสสุ่ม (หัวข้อ 1)
> - [x] **ระบบกำลังภายใน (內力系統)** — 內力=MP, สีตามสายอิน/หยาง/สมดุล, 基本內功 เพดาน, 修煉內力, ฟื้นฟู (凝神調息/氣匯百川/體力), 自動戰鬥 (หัวข้อ 1)
> - [x] **ระบบวิชาตัวเบา (輕功系統)** — move range/initiative/หลบ/เพดาน 100, ฟังก์ชันกระโดด-หนี (เปลือง內力), วิชา 3 ชนิด (梯雲縱/神行百變/凌波微步) (หัวข้อ 1)
> - [x] **ระบบการสวมใส่อุปกรณ์ (裝備系統)** — 8 ช่องสวมใส่, อาวุธ 5 ชนิดผูกวิชา, 耐久/負重/四種抗性, 專屬/通用, 強化(+1/−1)/鑲嵌, ซ่อมที่ 錢莊, เซ็ต (真朱雀/至尊天悟裝) (หัวข้อ 1)
> - [x] **ระบบเวลา (時間系統)** — เวลาออนไลน์สะสม (gate 絕學 3,000 ชม.), 活動時刻表, เวลาบำรุงรักษา, 修煉/自動練功, 防沉迷 (หัวข้อ 1)
> - [x] **วัฏจักรกลางวัน-กลางคืน (晝夜):** ยืนยันว่า **มีจริง** (กลางคืน NPC บางตัวหาย + กระทบ 運鏢) แต่ทำได้ไม่ดี · ระบบสภาพอากาศ (ฝน) มี
> - [ ] **ฤดูกาล (季節) / หิมะ (雪):** ยังไม่พบยืนยัน — ต้องดูคลิป gameplay
>
...
- พรรค: [〈金庸群侠传online〉帮会的建立 — 游侠网](http://article.ali213.net/html/1433.html)
- ตลาด/ร้าน/商城: [商城功能](https://jy.orientaldragon.com.tw/node/26) · [店鋪功能](https://jy.orientaldragon.com.tw/node/23) · [區域攤位查詢](https://jy.orientaldragon.com.tw/node/246)
- คราฟต์/養成: [內丹進化](https://jy.orientaldragon.com.tw/node/107) · [五行內丹](http://jy.orientaldragon.com.tw/遊戲介紹/武學系統/五行內丹/) · [至尊天命武器](https://jy.orientaldragon.com.tw/node/202) · [内丹进化(加成) — 17173](http://jyqxz.17173.com/content/09042018/200907913.shtml)
- แผนที่/พิกัด: [金庸群俠傳Online 地圖/坐標 — 守塔](https://m.shouta.cn/news/20220815325.html) · [17173 地圖專區](https://jinyong.17173.com/ditu/ditu.htm)
- ระบบบ้าน/แต่งงาน: [详尽新手指引 — 至尊服](http://jy16.online-game.com.cn/yxzl-1-1-243.html)

**ระบบในเมือง & ระบบเวลา (เพิ่ม 2026-06-21 — WebSearch):**
- เมือง/NPC: [新手攻略 — 至尊服](http://jy16.online-game.com.cn/hotcon-12.html) · [小任务合集——其他篇 — jy2001](https://www.jy2001.net/t/1876.html) · [赚钱专区 — 17173](https://jinyong.17173.com/zhuanqian/zhuanqian.htm) · [新人发展路线 — jy2001](https://www.jy2001.net/t/775.html)
- เวลา: [活動時刻表 — 武林至尊](http://jy.orientaldragon.com.tw/【至尊特色】活動時刻表/) · [活动时间表 — jy2001](https://www.jy2001.net/huodong) · [绝学/绝内/新武点本要求 (เวลาออนไลน์ 3000 ชม.) — jy2001](https://www.jy2001.net/t/2100.html) · [绝学介绍 — 至尊服](http://jy16.online-game.com.cn/yxzls-100.html)
- วัฏจักรกลางวัน-กลางคืน/ข้อตำหนิ: [当年《金庸群侠传Online》究竟是怎样走向没落的？— 知乎](https://www.zhihu.com/question/25669865) · [如何评价《金庸群侠传online》— 知乎](https://www.zhihu.com/question/22910511)
- สเตตัสตัวละคร/ค่าคุณสมบัติกำเนิด: [属性点介绍 — 至尊服](http://jy16.online-game.com.cn/yxzls-19.html) · [人物屬性 — 武林至尊](http://jy.orientaldragon.com.tw/新手入門/人物屬性/) · [新人发展路线 (資質配點) — jy2001](https://www.jy2001.net/t/775.html) · [資質屬性詳解 — 電玩狂人](https://playgame.wiki/hojy/gonglue/cd55f81ed4) · [เข้าเกมครั้งแรก (ชื่อสเตตัสไทย) — JY Online TH blog](http://jyonlineth.blogspot.com/2011/09/blog-post_16.html)
- ระบบวันเกิด: [创建角色达成悟性100参考 — 怀旧版攻略站](https://www.jytzst.cn/normal/detail/174) · [游戏角色创建 — 怀旧版攻略站](https://www.jytzst.cn/normal/detail/169)
- ระบบกำลังภายใน (內力): [新手成長必要過程 — 巴哈姆特](https://forum.gamer.com.tw/Co.php?bsn=2605&sn=40594) · [內力該如何提升 — 巴哈姆特](https://forum.gamer.com.tw/Co.php?bsn=2605&sn=32801) · [至尊版新人快速入门 — QQ](https://syzs.qq.com/blog/news/20200902A0PABS00)
- ระบบวิชาตัวเบา (輕功): [輕功介紹 — jy2001](https://www.jy2001.net/t/887.html) · [神行百變 — 九天劍盟](https://sites.google.com/a/podcatl.co.cc/ninesky/jiang-hu-wu-xue-nei-gong-pian/shen-xing-bai-bian) · [凌波微步 vs 神行百變 — PTT](https://www.ptt.cc/bbs/C_Chat/M.1658509271.A.DDB.html)
- ระบบสวมใส่อุปกรณ์ (裝備): [所有属性装备及武器 — jy2001](https://www.jy2001.net/t/71.html) · [门派专属装备 — 至尊服](http://jy16.online-game.com.cn/yxzl-4-3-203.html) · [裝備之屬性 — 巴哈姆特精華區](https://forum.gamer.com.tw/G2.php?bsn=2605&sn=151) · [至尊天悟裝 — 武林至尊](https://jy.orientaldragon.com.tw/node/226) · [屬性裝備 — qqnjy](https://www.qqnjy.com/others/attribute)
