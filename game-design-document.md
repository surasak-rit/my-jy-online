...
### 8. ⚔️ สำนักยอดกระบี่ฮว่าซาน (華山)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** ยอดเขาฮว่าซาน · สั่นซี — เข้าได้จากแผนที่ยุทธภพ → โซน `huashan_peak`
- **ตำนาน:** สำนักกระบี่ลือนาม วิถี 'ไร้กระบวนชนะมีกระบวน' กระบี่เดียวดายเก้ากระบวนของตูกูฉิวป้าย
- **เงื่อนไขเข้าสำนัก:** ทุกคน
- **อาจารย์:** ปรมาจารย์เฟิงชิงหยาง (เจ้าสำนักฮว่าซาน)
- **วิชาเอก:** กระบี่เดียวดายเก้ากระบวน (external/sword) — กระบี่ไร้กระบวน เล็งจุดอ่อน โจมตีสูงสุด
- **อาวุธประจำสำนัก (ไอเทม):** กระบี่ยอดม่วง 紫霞劍 · +ATK 20 (ราคา 300)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `กระบี่จรนอกรีต` (HP 60) → ดรอปเหรียญ 8–16 + เหล็กเย็นยอดเขา 寒鐵 (40%)
  - **บอส** `ปีศาจกระบี่ยอดเขา` (HP 450) → เหรียญ 90–180 + กระบี่ยอดม่วง 紫霞劍 (25%) + เหล็กเย็นยอดเขา 寒鐵×3
- **การเก็บวัตถุดิบ:** เหล็กเย็นยอดเขา 寒鐵 — ขุดจากสายแร่หน้าผาฮว่าซาน
- **การทำอาชีพ (生活技能):** ช่างตีกระบี่ (鑄劍師) — หลอมเหล็กเย็นเป็นกระบี่/อาวุธมีคม
  - สูตรคราฟต์: เหล็กเย็นยอดเขา×4 + ถ่านไม้สน×3 → กระบี่ +atk → **กระบี่หลอมเย็น** (ช่างตีกระบี่ (鑄劍師))
- **เควสที่เกี่ยวข้อง:**
  - `huashan_peak_join` — ฝากตัวสำนักยอดกระบี่ฮว่าซาน (รางวัล SP 12 + เหรียญ 40)
  - `huashan_peak_hunt` — ปราบปีศาจกระบี่ยอดเขา (รางวัล SP 30 + เหรียญ 120 + กระบี่ยอดม่วง 紫霞劍)


### 9. 🌸 เกาะดอกท้อ (桃花)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** เกาะดอกท้อ · ทะเลตะวันออก — เข้าได้จากแผนที่ยุทธภพ → โซน `peach_isle`
- **ตำนาน:** วิมานกลางทะเลของบูรพาเทพ เขาวงกตดอกท้อ วิชาพิสดารห้าธาตุ พิณขลุ่ยสะกดจิต
- **เงื่อนไขเข้าสำนัก:** ทุกคน
- **อาจารย์:** บูรพาเทพหวงเหยาซือ (เจ้าเกาะดอกท้อ)
- **วิชาเอก:** ขลุ่ยหยกสะกดวิญญาณ (internal/flute) — คลื่นเสียงปราณ สั่นสะเทือนจิตศัตรู
- **อาวุธประจำสำนัก (ไอเทม):** ขลุ่ยหยกเขียว 碧玉簫 · +ATK 15 (ราคา 290)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `งูเขาวงกตดอกท้อ` (HP 64) → ดรอปเหรียญ 8–17 + ยางดอกท้อพันปี 桃膠 (40%)
  - **บอส** `โจรสลัดลมดำ` (HP 460) → เหรียญ 95–185 + ขลุ่ยหยกเขียว 碧玉簫 (25%) + ยางดอกท้อพันปี 桃膠×3
- **การเก็บวัตถุดิบ:** ยางดอกท้อพันปี 桃膠 — กรีดจากต้นท้อโบราณในเขาวงกต
- **การทำอาชีพ (生活技能):** ช่างเครื่องดนตรี/ดนตรียุทธ (樂師) — ทำขลุ่ยพิณ + เพลงปราณเสริมพวกพ้อง
  - สูตรคราฟต์: ยางดอกท้อพันปี×3 + ไผ่หยก×2 → เครื่องดนตรีเสริมปราณ → **ขลุ่ย/พิณคุณภาพ** (ช่างเครื่องดนตรี (制器))
- **เควสที่เกี่ยวข้อง:**
  - `peach_isle_join` — ฝากตัวเกาะดอกท้อ (รางวัล SP 12 + เหรียญ 40)
  - `peach_isle_hunt` — ปราบโจรสลัดลมดำ (รางวัล SP 30 + เหรียญ 120 + ขลุ่ยหยกเขียว 碧玉簫)


### 10. 🕯️ สำนักสุสานโบราณ (古墓)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** สุสานโบราณ · เขาจงหนาน สั่นซี — เข้าได้จากแผนที่ยุทธภพ → โซน `ancient_tomb`
- **ตำนาน:** สำนักหญิงล้วนหลบเร้นในสุสาน วิชาดรุณีหยก เชือกอ่อน-เข็มเงิน หลับบนเชือกฝึกปราณ
- **เงื่อนไขเข้าสำนัก:** เพศ female
- **อาจารย์:** อาจารย์หญิงเสี่ยวหลงหนฺหวี่ (เจ้าสำนักสุสานโบราณ)
- **วิชาเอก:** กระบี่ดรุณีหยก (internal/sword) — กระบี่หญิงพิสุทธิ์ จับคู่ปราณ เย็นเฉียบ
- **อาวุธประจำสำนัก (ไอเทม):** เชือกทองใยฟ้า 金絲索 · +ATK 14 (ราคา 275)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `ค้างคาวเฝ้าสุสาน` (HP 58) → ดรอปเหรียญ 7–15 + ใยไหมหยกเย็น 玉蠶絲 (40%)
  - **บอส** `ผีดิบเฝ้าโลงหยก` (HP 440) → เหรียญ 85–175 + เชือกทองใยฟ้า 金絲索 (25%) + ใยไหมหยกเย็น 玉蠶絲×3
- **การเก็บวัตถุดิบ:** ใยไหมหยกเย็น 玉蠶絲 — สาวจากหนอนไหมหยกในสุสาน
- **การทำอาชีพ (生活技能):** ช่างทอผ้าไหม (織錦師) — ทอชุดเบา/เชือกใยหยกเพิ่มป้องกัน
  - สูตรคราฟต์: ใยไหมหยกเย็น×4 + ด้ายเงิน×2 → เกราะผ้าเบาเสริม def → **ชุด/เชือกใยหยก** (ช่างทอผ้าไหม (織錦))
- **เควสที่เกี่ยวข้อง:**
  - `ancient_tomb_join` — ฝากตัวสำนักสุสานโบราณ (รางวัล SP 12 + เหรียญ 40)
  - `ancient_tomb_hunt` — ปราบผีดิบเฝ้าโลงหยก (รางวัล SP 30 + เหรียญ 120 + เชือกทองใยฟ้า 金絲索)


### 11. ❄️ สำนักคุนหลุน (崑崙)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** เทือกเขาคุนหลุน · ชิงไห่ — เข้าได้จากแผนที่ยุทธภพ → โซน `kunlun_snow`
- **ตำนาน:** สำนักดาบบนหลังคาโลก ปราณเย็นเยือก วิชาดาบเมฆาหิมะ ใจกว้างดั่งหิมะขาว
- **เงื่อนไขเข้าสำนัก:** ทุกคน
- **อาจารย์:** ปรมาจารย์เหอจู๋เต้า (เจ้าสำนักคุนหลุน)
- **วิชาเอก:** ดาบเมฆาหิมะ (external/sword) — ดาบปราณเย็น เฉือนพร้อมเกล็ดหิมะแช่แข็ง
- **อาวุธประจำสำนัก (ไอเทม):** ดาบจันทร์หิมะ 雪月刀 · +ATK 19 (ราคา 295)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `หมาป่าหิมะคุนหลุน` (HP 66) → ดรอปเหรียญ 8–17 + บัวหิมะพันปี 雪蓮 (40%)
  - **บอส** `ยักษ์หิมะหลังคาโลก` (HP 470) → เหรียญ 95–190 + ดาบจันทร์หิมะ 雪月刀 (25%) + บัวหิมะพันปี 雪蓮×3
- **การเก็บวัตถุดิบ:** บัวหิมะพันปี 雪蓮 — เก็บจากผาหิมะสูงชัน
- **การทำอาชีพ (生活技能):** หมอสมุนไพร/นักปีนผา (採藥師) — เก็บบัวหิมะปรุงยาบำรุงปราณ
  - สูตรคราฟต์: บัวหิมะพันปี×2 + น้ำแข็งพันปี×2 → ยาเพิ่ม maxHp ถาวรเล็กน้อย → **ยาเสริมปราณเย็น** (หมอสมุนไพรหิมะ (採藥))
- **เควสที่เกี่ยวข้อง:**
  - `kunlun_snow_join` — ฝากตัวสำนักคุนหลุน (รางวัล SP 12 + เหรียญ 40)
  - `kunlun_snow_hunt` — ปราบยักษ์หิมะหลังคาโลก (รางวัล SP 30 + เหรียญ 120 + ดาบจันทร์หิมะ 雪月刀)


### 12. 🔥 พรรคไฟศักดิ์สิทธิ์ (明教)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** ยอดเขาเฉียนคุน (光明頂) · ตะวันตก — เข้าได้จากแผนที่ยุทธภพ → โซน `sacred_flame`
- **ตำนาน:** ลัทธิบูชาไฟลึกลับ ถูกใส่ร้ายเป็นมารแต่ทำเพื่อราษฎร วิชาฝ่ามือเปลวสุริยา ปราณเฉียนคุน
- **เงื่อนไขเข้าสำนัก:** ทุกคน
- **อาจารย์:** ประมุขเปลวจางอู๋จี้ (ประมุขพรรคไฟศักดิ์สิทธิ์)
- **วิชาเอก:** ฝ่ามือเปลวสุริยา (external/palm) — ฝ่ามือไฟแรงสุริยา เผาผลาญรุนแรง
- **อาวุธประจำสำนัก (ไอเทม):** ดาบเปลวสุริยัน 烈陽刀 · +ATK 21 (ราคา 310)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `สาวกคลั่งไฟ` (HP 64) → ดรอปเหรียญ 8–18 + ถ่านไฟนิรันดร์ 不滅炭 (40%)
  - **บอส** `ผู้พิทักษ์เปลวเฉียนคุน` (HP 480) → เหรียญ 100–200 + ดาบเปลวสุริยัน 烈陽刀 (25%) + ถ่านไฟนิรันดร์ 不滅炭×3
- **การเก็บวัตถุดิบ:** ถ่านไฟนิรันดร์ 不滅炭 — ขุดจากบ่อลาวาใต้เฉียนคุน
- **การทำอาชีพ (生活技能):** ช่างหลอมไฟ (鍛冶師) — ใช้ถ่านนิรันดร์หลอมอาวุธไฟ/ลูกระเบิดเพลิง
  - สูตรคราฟต์: ถ่านไฟนิรันดร์×4 + เหล็กดิบ×3 → อาวุธ +atk ไฟ → **อาวุธหลอมไฟ** (ช่างหลอมไฟ (鍛冶師))
- **เควสที่เกี่ยวข้อง:**
  - `sacred_flame_join` — ฝากตัวพรรคไฟศักดิ์สิทธิ์ (รางวัล SP 12 + เหรียญ 40)
  - `sacred_flame_hunt` — ปราบผู้พิทักษ์เปลวเฉียนคุน (รางวัล SP 30 + เหรียญ 120 + ดาบเปลวสุริยัน 烈陽刀)


### 13. ☝️ ตระกูลต้วนต้าหลี่ (大理)

- **ที่ตั้งบนแผนที่ (จุดยุทธภพ):** ราชสำนักต้าหลี่ · ยูนนาน (วัดเทียนหลง) — เข้าได้จากแผนที่ยุทธภพ → โซน `dali_duan`
- **ตำนาน:** ราชวงศ์ต้วนแห่งต้าหลี่ พุทธ+ยุทธ วิชานิ้วเอกสุริยัน '六脈神劍' ปล่อยปราณกระบี่จากนิ้ว
- **เงื่อนไขเข้าสำนัก:** ทุกคน
- **อาจารย์:** เจ้าชายต้วนเจิ้งหมิง (ประมุขตระกูลต้วน)
- **วิชาเอก:** กระบี่ปราณหกชีพจร (internal/finger) — ปล่อยปราณกระบี่จากปลายนิ้ว โจมตีไกลไร้รูป
- **อาวุธประจำสำนัก (ไอเทม):** ถุงมือนิ้วเอกสุริยัน 一陽指套 · +ATK 18 (ราคา 320)
- **มอนสเตอร์ + การดรอป:**
  - ลิ่วล้อ `องครักษ์วัดเทียนหลง` (HP 66) → ดรอปเหรียญ 9–18 + แผ่นทองพุทธบูชา 金箔 (40%)
  - **บอส** `นักพรตมารวัดร้าง` (HP 500) → เหรียญ 105–210 + ถุงมือนิ้วเอกสุริยัน 一陽指套 (25%) + แผ่นทองพุทธบูชา 金箔×3
- **การเก็บวัตถุดิบ:** แผ่นทองพุทธบูชา 金箔 — รับจากการบูรณะวัด/เก็บในเจดีย์
- **การทำอาชีพ (生活技能):** ช่างทอง/หล่อพระ (鎏金師) — ทำเครื่องรางปราณเพิ่ม內力
  - สูตรคราฟต์: แผ่นทองพุทธบูชา×3 + หยกขาว×2 → เครื่องราง +maxMp → **เครื่องรางปราณ** (ช่างทอง/หล่อพระ (鎏金師))
- **เควสที่เกี่ยวข้อง:**
  - `dali_duan_join` — ฝากตัวตระกูลต้วนต้าหลี่ (รางวัล SP 12 + เหรียญ 40)
  - `dali_duan_hunt` — ปราบนักพรตมารวัดร้าง (รางวัล SP 30 + เหรียญ 120 + ถุงมือนิ้วเอกสุริยัน 一陽指套)


## ภาคผนวก M — แผนที่ยุทธภพ (江湖 Overworld) แบบกระจายภูมิภาค

แผนที่ยุทธภพขนาด **56×42** ช่อง · เข้าจากนครจิ่วเหอ (ทางเข้าใต้-กลาง 28,39)

> **ออกแบบใหม่:** สำนักทั้ง 13 *กระจายตามภูมิศาสตร์จริง* ไม่กระจุกรวมกัน — แดนหิมะเหนือ · ทะเลตะวันออก · ภูเขาตะวันตก · เสฉวน/ยูนนานใต้ · 中原 กลางแผ่นดิน
> มี **ดินแดนรกร้าง+มอนคั่นระหว่างภูมิภาค** ผู้เล่นต้อง**เดินทางผจญภัย**ไปยังที่ตั้งสำนัก แล้วคุยอาจารย์ในสำนักเพื่อ**ฝากตัว** (ฝากตัวจากที่อื่นไม่ได้)

| สำนัก | ภูมิภาค | พิกัด (x,y) |
|------|--------|------------|
| ⛰️ สำนักศิลาวัชระ (金剛) | — | 30,20 |
| 🌙 สำนักเงาจันทรา (月影) | — | 41,29 |
| 🪷 สำนักบัวคราม (碧蓮) | — | 47,22 |
| 🐉 สำนักมังกรเมฆา (雲龍) | ยอดเขาเมฆา (เขาบู๊ตึ้ง · หูเป่ย) | 18,21 |
| 🥢 พรรคยาจก (丐幫) | ตลาดเมืองหยางโจว · ลานใต้สะพาน | 23,27 |
| 🎯 ตระกูลถัง (唐門) | คฤหาสน์ถัง · เสฉวน | 15,33 |
| 🐍 พรรคห้าพิษ (五毒) | หุบเหวพิษ · ยูนนาน (เหมียวเจียง) | 25,38 |
| ⚔️ สำนักยอดกระบี่ฮว่าซาน (華山) | ยอดเขาฮว่าซาน · สั่นซี | 14,12 |
| 🌸 เกาะดอกท้อ (桃花) | เกาะดอกท้อ · ทะเลตะวันออก | 50,13 |
| 🕯️ สำนักสุสานโบราณ (古墓) | สุสานโบราณ · เขาจงหนาน สั่นซี | 9,18 |
| ❄️ สำนักคุนหลุน (崑崙) | เทือกเขาคุนหลุน · ชิงไห่ | 11,4 |
| 🔥 พรรคไฟศักดิ์สิทธิ์ (明教) | ยอดเขาเฉียนคุน (光明頂) · ตะวันตก | 5,9 |
| ☝️ ตระกูลต้วนต้าหลี่ (大理) | ราชสำนักต้าหลี่ · ยูนนาน (วัดเทียนหลง) | 8,37 |

**กลไกการเดินทาง/ฝากตัว:**
- จากเมือง → ประตู *แผนที่ยุทธภพ* → โผล่ที่ทางเข้าใต้ เดินตามถนนสายยุทธภพ
- เส้นทางไปแต่ละสำนักมีมอนประจำถิ่น (ลิ่วล้อสำนักนั้น) + โจร/หมาป่าในที่รกร้างคอยดัก
- ถึงป้ายสำนัก (漢字) → เข้าโซนลานสำนัก → คุยอาจารย์เพื่อฝากตัว+เรียนวิชา
- ออกจากสำนัก → กลับมาโผล่ ณ ที่ตั้งสำนักบนแผนที่ (ไม่ดีดกลับทางเข้า) เดินทางต่อได้


## ภาคผนวก Z — ขนาดแผนที่ลานสำนัก (ไม่เท่ากัน)

แต่ละสำนักมี tilemap เฉพาะของตัวเอง ขนาด/ภูมิประเทศต่างกันตามลักษณะสำนัก (ไม่ใช้แผนที่ร่วมแล้ว):

| สำนัก | ขนาด (กxส) | ภูมิประเทศ |
|------|-----------|-----------|
| 🐉 สำนักมังกรเมฆา | 20×28 | หิมะ/หินอ่อน |
| 🥢 พรรคยาจก | 28×16 | ลานหญ้า/หิน |
| 🎯 ตระกูลถัง | 18×18 | ลานหญ้า/หิน |
| 🐍 พรรคห้าพิษ | 16×26 | ลานหญ้า/หิน |
| ⚔️ สำนักยอดกระบี่ฮว่าซาน | 18×30 | หิมะ/หินอ่อน |
| 🌸 เกาะดอกท้อ | 32×22 | เกาะ-ทะเลล้อม |
| 🕯️ สำนักสุสานโบราณ | 15×14 | ลานหญ้า/หิน |
| ❄️ สำนักคุนหลุน | 30×26 | หิมะ/หินอ่อน |
| 🔥 พรรคไฟศักดิ์สิทธิ์ | 24×24 | ลานหญ้า/หิน |
| ☝️ ตระกูลต้วนต้าหลี่ | 30×18 | ลานหญ้า/หิน |

- ทางเข้าลานสำนักอยู่ขอบซ้าย (ประตูโคมไฟ) → ศาลาหลัก+ป้าย漢字อยู่ด้านบน → อาจารย์หน้าศาลา
- มอนลิ่วล้อ+บอสกระจายครึ่งล่างของลาน · ขอบแผนที่กั้นเขตเอง (ไม่มีกำแพงล่องหน)


## ภาคผนวก W — โครงสร้างโลกหลายแผนที่ (แทนภาคผนวก M)

> **กฎใหม่:** 1 แผนที่ใหญ่ มีสำนักได้ **สูงสุด 2 สำนัก** วาง**ห่างกันคนละมุม** (ห่าง 25–32 ช่อง) มีดินแดนรกร้าง+มอนคั่นกลาง

**ชุมทางยุทธภพ (江湖中樞)** — hub กลาง (34×24) เข้าจากนครจิ่วเหอ · มีประตูสู่ 7 ภูมิภาค (ตัวมันเองไม่มีสำนัก)

| ภูมิภาค (แผนที่ใหญ่) | ขนาด | สำนัก (≤2 · คนละมุม) |
|---|---|---|
| ที่ราบกลาง 中原 | 40×28 | ⛰️สำนักศิลาวัชระ · 🥢พรรคยาจก |
| เจียงหนานตะวันออก 江南 | 38×26 | 🪷สำนักบัวคราม · 🌙สำนักเงาจันทรา |
| เทือกเขาตะวันตก 西嶽 | 28×34 | ⚔️สำนักยอดกระบี่ฮว่าซาน · 🕯️สำนักสุสานโบราณ |
| แดนหิมะเหนือ 北域 | 42×26 | ❄️สำนักคุนหลุน · 🔥พรรคไฟศักดิ์สิทธิ์ |
| แดนฉู่-สู่ 楚蜀 | 36×30 | 🐉สำนักมังกรเมฆา · 🎯ตระกูลถัง |
| แดนใต้ยูนนาน 滇南 | 32×32 | ☝️ตระกูลต้วนต้าหลี่ · 🐍พรรคห้าพิษ |
| เกาะทะเลตะวันออก 東海 | 28×24 | 🌸เกาะดอกท้อ |

**การเดินทาง/ฝากตัว:**
- นครจิ่วเหอ → ชุมทางยุทธภพ → เลือกประตูภูมิภาค → **แผนที่ภูมิภาคใหญ่**
- ในภูมิภาค: สำนัก 2 แห่งอยู่คนละมุม ต้องเดินผ่านที่รกร้าง (โจร/หมาป่า/ลิ่วล้อสำนัก) ไปถึงป้ายสำนัก
- เข้าลานสำนัก → คุยอาจารย์เพื่อ**ฝากตัว** (ฝากตัวจากที่อื่นไม่ได้) → ออกมาโผล่ที่ตั้งสำนักในภูมิภาคเดิม
- กลับชุมทางได้จากประตูกลางล่างของภูมิภาค


## ภาคผนวก K — ระบบวิชาแต่ละสำนัก (≥10 วิชา · ชั้นต่ำ/กลาง/สูง + 絕學เควส)

ทุกสำนักมี **11 วิชา** ครบสาย 外功·內功·輕功 แบ่ง 4 ชั้น และมีวิชาลับ 2 วิชาที่ปลดล็อกตามเนื้อเรื่อง:

| ชั้น | จำนวน | รายละเอียด |
|---|---|---|
| **ต่ำ** | 3 | 輕功ขั้นต้น · 內功ปฐมฌาน · 外功ปฐมบท (ราคา ✦5) |
| **กลาง** | 3 | 內功สมาธิญาณ · 外功พิสัยกลาง/วิถีชำนาญ (✦7) |
| **สูง** | 3 | 輕功ลมกรด · 內功มหาปราณ · 外功อุกฤษฏ์ (✦9) |
| **絕學 (เควส)** | 2 | วิชาลับขั้นสูงสุด — ปลดล็อกตามเงื่อนไข |

**เงื่อนไขปลดล็อก絕學 (วิชาเควส):**
- `絕學·เคล็ดสุดยอด` (外功 ✦10) — ปลดล็อกเมื่อ**ฝึกวิชาเอกขั้นสูงถึงระดับ 5** (`unlock.skill`)
- `絕學·อสีติยานุภาพ` (內功 ✦12) — ปลดล็อกเมื่อ**ผ่านบททดสอบสำนัก** เควส `<สำนัก>_trial` (`unlock.quest`)
- เอนจินบังคับเงื่อนไขจริงใน `core/skills.js` (`unlockState`) · UI โชว์ 🔒 + เงื่อนไข · เรียงวิชาตามชั้น

**ตัวอย่างชุดวิชา — สำนักยอดกระบี่ฮว่าซาน (華山):**

| วิชา | ประเภท | ชั้น | ปลดล็อก |
|---|---|---|---|
| ย่างเมฆาเขา | 輕功 | ต่ำ | — |
| ย่างเมฆาเขาลมกรด | 輕功 | สูง | — |
| ปราณจื่อเสียปฐมฌาน | 內功 | ต่ำ | — |
| ปราณจื่อเสียสมาธิญาณ | 內功 | กลาง | — |
| ปราณจื่อเสียมหาปราณ | 內功 | สูง | — |
| กระบี่ฮว่าซานปฐมบท | 外功 | ต่ำ | — |
| กระบี่ฮว่าซานพิสัยกลาง | 外功 | กลาง | — |
| กระบี่ฮว่าซานวิถีชำนาญ | 外功 | กลาง | — |
| กระบี่เดียวดายเก้ากระบวน | 外功 | สูง | — |
| 絕學·เก้ากระบวนเคล็ดสุดยอด | 外功 | 絕學 | ฝึก lonely_nine ถึง r5 |
| 絕學·เก้ากระบวนอสีติยานุภาพ | 內功 | 絕學 | เควส huashan_peak_trial |

> รวมทั้งเกม: **143 วิชา** (13 สำนัก × 11) · บททดสอบสำนัก 13 เควส
