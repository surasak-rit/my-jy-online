...
> [!important] 🎨 ทิศทางที่ใช้จริง (อัปเดต): **หมึกจีน/ลายพู่กัน (水墨 ink-brush wuxia) + ตัวละครจิบิ**
...
> และตัวละครเป็น **จิบิ (หัวโต ~2–2.5 หัว, ตาโต)** มีขอบหมึก — ไม่ใช่สัดส่วนสมจริง 7.5 หัวตามร่างเดิมด้านล่าง
> - **Implemented แล้วใน Phase 1** (`render/sprites.js` จิบิ+ขอบหมึก · `render/tilemap.js` พื้นหมึกจาง · `styles/ui.css` ม้วนคัมภีร์/ตราชาด · ป้ายชื่อ = แผ่นกระดาษสา)
