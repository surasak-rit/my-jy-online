...
> [!info] ขอบเขต
> กำหนด **สัดส่วนตัวละครแบบสมจริง (realistic adult)** + ข้อกำหนด sprite สำหรับมุม **2D isometric** ให้ทีม art ทำได้ตรงกัน
> ยึดทิศทางจาก reference: JY Online เป็นอาร์ต **"สมจริง ไม่ใช่การ์ตูน/chibi"** → เราเลือกสัดส่วนผู้ใหญ่จริง ไม่ใช่หัวโต
...
- **เน้น silhouette-first:** ทรงเงาต้องบอกสำนัก/อาวุธได้แม้เป็นเงาดำล้วน
- **สีตามสำนัก (จาก §4.2)** เป็น accent หลัก: ศิลาวัชระ น้ำตาล-ทอง · ธารเมตตา ขาว-ฟ้า · เงาจันทร์ ดำ-เงิน
...
#### C.6.2 ชุดสำนัก vs เกราะที่สวม (ลำดับความสำคัญการแสดงผล)
> [!note] กันความสับสน "ใส่เกราะแล้วชุดสำนักหายไหม?"
> - **ค่าเริ่มต้น:** ชุดสำนัก (§4.2) = "สกินพื้นฐาน" ของช่องเสื้อ · พอสวมเกราะจริง → เกราะ**ทับ**การแสดงผล แต่คง **โทนสี/ตรา (accent) ของสำนัก** (เกราะรับ palette สำนัก)
> - **專屬ของสำนัก** ออกแบบให้เข้าธีมสำนักอยู่แล้ว · **通用** ใช้ palette swap ย้อมสีตามสำนัก → ผู้เล่นยังดูออกว่าสังกัดไหน
...
- **สำนัก:** **ตรา (crest icon) + ชื่อย่อสำนัก** ใช้ **สีประจำสำนัก** (ศิลาวัชระ น้ำตาล-ทอง · ธารเมตตา ขาว-ฟ้า · เงาจันทร์ ดำ-เงิน) → ดูสีก็เดาสังกัดได้ · ไม่มีสำนัก = 〈พเนจร〉
